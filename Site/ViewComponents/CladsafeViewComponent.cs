...
{
    public class CladsafeViewComponent : ViewComponent
    {
        SiteContext _context;
        private readonly IOptions<AppSettings> _config;

        public CladsafeViewComponent(SiteContext context, IOptions<AppSettings> config)
        {
            _context = context;
            _config = config;
        }
        ...
        public IViewComponentResult Invoke()
        {
            ...
            return View("_Cladsafe", DefaultViewModel);
        }
    }
}
