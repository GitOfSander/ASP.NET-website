...
{
    public class NewspaperViewComponent : ViewComponent
    {
        SiteContext _context;
        private readonly IOptions<AppSettings> _config;

        public NewspaperViewComponent(SiteContext context, IOptions<AppSettings> config)
        {
            _context = context;
            _config = config;
        }
        ...
        public IViewComponentResult Invoke()
        {
            ...
            return View("_Newspaper", DefaultViewModel);
        }
    }
}
